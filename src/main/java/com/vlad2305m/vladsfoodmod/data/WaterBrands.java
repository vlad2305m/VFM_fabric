package com.vlad2305m.vladsfoodmod.data; public class WaterBrands { public static final String[] brands = {"Acqua Panna" ,
 "Aqua Carpatica" ,
 "Agua Cinco Estrellas" ,
 "AdeS" ,
 "Agua Mineral Salus" ,
 "Agua Vida" ,
 "Ambo Mineral Water" ,
 ...
 "HappyWater" ,
 "Harrogate Spa Water" ,
 "HerbalH2O Reusable Glass Bottled Enhanced Water." ,
 "Highland Spring" ,
 "Himalaya" ,
 "Ice Mountain" ,
